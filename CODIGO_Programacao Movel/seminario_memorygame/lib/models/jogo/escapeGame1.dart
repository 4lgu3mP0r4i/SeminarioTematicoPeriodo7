...
import 'escapeGame2.dart';
import 'escapeGame3.dart';

class EscapeGame1 extends StatefulWidget {
  const EscapeGame1({Key? key}) : super(key: key);
  @override
  _EscapeGame1State createState() => _EscapeGame1State();
}

class _EscapeGame1State extends State<EscapeGame1> {
  ...
  List<String> cards = [
    "assets/images/fase1/1.jpeg",
    "assets/images/fase1/2.jpeg",
    "assets/images/fase1/3.jpeg",
    "assets/images/fase1/1.jpeg",
    "assets/images/fase1/2.jpeg",
    "assets/images/fase1/3.jpeg"
  ];
  ...
  bool mostrarProximoBotao = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: onlyColorScreen.blueBackground,
        child: Padding(
