...
import 'package:seminario_memorygame/models/jogo/escapeGame3.dart';
import 'package:seminario_memorygame/models/jogo/escapeGame4.dart';
...
class EscapeGame3 extends StatefulWidget {
  const EscapeGame3({Key? key}) : super(key: key);
  @override
  _EscapeGame3State createState() => _EscapeGame3State();
}

class _EscapeGame3State extends State<EscapeGame3> {
  ...
  List<String> cards = [
    "assets/images/fase3/1.jpeg",
    "assets/images/fase3/2.jpeg",
    "assets/images/fase3/3.jpeg",
    "assets/images/fase3/1.jpeg",
    "assets/images/fase3/2.jpeg",
    "assets/images/fase3/3.jpeg"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: onlyColorScreen.greenBackground,
        child: Padding(
