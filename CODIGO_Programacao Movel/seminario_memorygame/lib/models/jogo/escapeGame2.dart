...
class EscapeGame2 extends StatefulWidget {
  const EscapeGame2({Key? key}) : super(key: key);
  @override
  _EscapeGame2State createState() => _EscapeGame2State();
}

class _EscapeGame2State extends State<EscapeGame2> {
  ...
  List<String> cards = [
    "assets/images/fase2/1.jpeg",
    "assets/images/fase2/2.jpeg",
    "assets/images/fase2/3.jpeg",
    "assets/images/fase2/1.jpeg",
    "assets/images/fase2/2.jpeg",
    "assets/images/fase2/3.jpeg"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: onlyColorScreen.redBackground,
        child: Padding(
