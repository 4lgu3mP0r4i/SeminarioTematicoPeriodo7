...
import 'package:seminario_memorygame/models/jogo/escapeGame_finish.dart';
...
class EscapeGame7 extends StatefulWidget {
  const EscapeGame7({Key? key}) : super(key: key);
  @override
  _EscapeGame7State createState() => _EscapeGame7State();
}

class _EscapeGame7State extends State<EscapeGame7> {
  ...
  List<String> cards = [
    "assets/images/fase7/1.jpeg",
    "assets/images/fase7/2.jpeg",
    "assets/images/fase7/3.jpeg",
    "assets/images/fase7/1.jpeg",
    "assets/images/fase7/2.jpeg",
    "assets/images/fase7/3.jpeg"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: onlyColorScreen.goldBackground,
        child: Padding(
