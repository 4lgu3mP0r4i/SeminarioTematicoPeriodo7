...
import 'escapeGame5.dart';

class EscapeGame4 extends StatefulWidget {
  const EscapeGame4({Key? key}) : super(key: key);
  @override
  _EscapeGame4State createState() => _EscapeGame4State();
}

class _EscapeGame4State extends State<EscapeGame4> {
  ...
  List<String> cards = [
    "assets/images/fase4/1.jpeg",
    "assets/images/fase4/2.jpeg",
    "assets/images/fase4/3.jpeg",
    "assets/images/fase4/1.jpeg",
    "assets/images/fase4/2.jpeg",
    "assets/images/fase4/3.jpeg"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: onlyColorScreen.blackBackground,
        child: Padding(
