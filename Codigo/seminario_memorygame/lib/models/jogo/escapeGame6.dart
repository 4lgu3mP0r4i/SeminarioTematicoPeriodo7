...
import 'package:seminario_memorygame/models/jogo/escapeGame7.dart';
...
class EscapeGame6 extends StatefulWidget {
  const EscapeGame6({Key? key}) : super(key: key);
  @override
  _EscapeGame6State createState() => _EscapeGame6State();
}

class _EscapeGame6State extends State<EscapeGame6> {
  ...
  List<String> cards = [
    "assets/images/fase6/1.jpeg",
    "assets/images/fase6/2.jpeg",
    "assets/images/fase6/3.jpeg",
    "assets/images/fase6/1.jpeg",
    "assets/images/fase6/2.jpeg",
    "assets/images/fase6/3.jpeg"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: onlyColorScreen.silverBackground,
        child: Padding(
